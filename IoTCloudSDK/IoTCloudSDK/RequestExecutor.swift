...
class RequestExecutor{
    ...
    func postRequest(urlString: String, requestHeaderDict: Dictionary<String, String>, requestBodyData: NSData, completionHandler: (response: NSDictionary?, error: IoTCloudError?) -> Void) -> Void
    {
        ...
        execRequest(request) { (response, error) -> Void in
            completionHandler(response: response, error: error)
        }
    }

    func getRequest(urlString: String, requestHeaderDict: Dictionary<String, String>, completionHandler: (response: NSDictionary?, error: IoTCloudError?) -> Void) -> Void
    {
        let url = NSURL(string: urlString)
        let request = NSMutableURLRequest(URL: url!)
    ...
    func execRequest(request: NSURLRequest, completionHandler: (response: NSDictionary?, error: IoTCloudError?) -> Void) {

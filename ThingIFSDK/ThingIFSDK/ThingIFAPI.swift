...
public class ThingIFAPI: NSObject, NSCoding {
    ...
    */
    ...
    {
        _postNewTrigger(schemaName, schemaVersion: schemaVersion, actions: actions, predicate: predicate, commandTarget: target != nil ? target : self.target, completionHandler: completionHandler)
    }

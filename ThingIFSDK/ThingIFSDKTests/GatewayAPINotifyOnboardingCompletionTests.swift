//
//  GatewayAPINotifyOnboardingCompletionTests.swift
//  ThingIFSDK
//
...
class GatewayAPINotifyOnboardingCompletionTests: GatewayAPITestBase {
    ...
    func testSuccess() throws
    {
        ...
        sharedMockSession.requestVerifier = makeRequestVerifier() { request in
            ...
            // verify path
            XCTAssertEqual(
                "\(api.gatewayAddress.absoluteString)/\(api.app.siteName)/apps/\(api.app.appID)/gateway/end-nodes/VENDOR_THING_ID:\(vendorThingID)",
    ...
    {
        let api = try getLoggedInGatewayAPI()
        let expectation = self.expectation(description: "testEmptyVendorThingIDError")
        let thingID = "dummyThingID"

...
class PostNewTriggerTests: SmallTestBase {
    ...
    func testPostNewTrigger_success() {
        ...
        let testsCases: [TestCase] = [
            // simple clause
            TestCase(clause: EqualsClause(field: "color", integer: 0), expectedClauseDict: ["type":"eq","field":"color", "value": 0], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            TestCase(clause: EqualsClause(field: "power", bool: true), expectedClauseDict: ["type":"eq","field":"power", "value": true], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            TestCase(clause: NotEqualsClause(field: "power", bool: true), expectedClauseDict: ["type": "not", "clause": ["type":"eq","field":"power", "value": true]], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            ...
            TestCase(clause: AndClause(clauses: EqualsClause(field: "color", integer: 0), NotEqualsClause(field: "power", bool: true)), expectedClauseDict: ["type": "and", "clauses": [["type":"eq","field":"color", "value": 0], ["type": "not", "clause": ["type":"eq","field":"power", "value": true]] ]], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            TestCase(clause: OrClause(clauses: EqualsClause(field: "color", integer: 0), NotEqualsClause(field: "color", bool: true)), expectedClauseDict: ["type": "or", "clauses": [["type":"eq","field":"color", "value": 0], ["type": "not", "clause": ["type":"eq","field":"power", "value": true]] ]], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            // complex clauses
            TestCase(clause: AndClause(clauses: EqualsClause(field: "brightness", integer: 50), OrClause(clauses: EqualsClause(field: "color", integer:  0), NotEqualsClause(field: "power", bool: true))), expectedClauseDict: complexExpectedClauses[0], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            TestCase(clause: OrClause(clauses: EqualsClause(field: "brightness", integer: 50),AndClause(clauses: EqualsClause(field: "color", integer: 0), NotEqualsClause(field: "power", bool: true))), expectedClauseDict: complexExpectedClauses[1], triggersWhen: TriggersWhen.CONDITION_FALSE_TO_TRUE, expectedTriggersWhenString: "CONDITION_FALSE_TO_TRUE"),
            // test triggersWhen
            TestCase(clause: EqualsClause(field: "color", integer: 0), expectedClauseDict: ["type":"eq","field":"color", "value": 0], triggersWhen: TriggersWhen.CONDITION_CHANGED, expectedTriggersWhenString: "CONDITION_CHANGED"),
            TestCase(clause: EqualsClause(field: "color", integer: 0), expectedClauseDict: ["type":"eq","field":"color", "value": 0], triggersWhen: TriggersWhen.CONDITION_TRUE, expectedTriggersWhenString: "CONDITION_TRUE")
    ...
    func testPostNewTrigger_http_404() {
        ...
        do{
            let actions: [Dictionary<String, AnyObject>] = [["turnPower":["power":true]],["setBrightness":["bribhtness":90]]]
            let clause = EqualsClause(field: "color", integer: 0)
